...
public class RoomResp extends Room {
	...
	private List<Long> qiangGangHuList = new ArrayList<Long>();//抢杠胡的集合 这里不用guoList 有点乱
	...
	public void initRoom() {
		...
		this.qiangGangHuList = new ArrayList<Long>();
	...
	public List<Long> getQiangGangHuList() {
		return qiangGangHuList;
	}

	public void setQiangGangHuList(List<Long> qiangGangHuList) {
		this.qiangGangHuList = qiangGangHuList;
	}
