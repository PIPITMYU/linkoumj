...
//		}
		...
		case 100200:
			if (room.getState() == Cnst.ROOM_STATE_GAMIING) {
				...
				roomInfo.put("playType", String.valueOf(room.getPlayType()));
	    		roomInfo.put("playerNum", String.valueOf(room.getPlayerNum()));
	    		roomInfo.put("sanQiSuanJia", String.valueOf(room.getSanQiSuanJia()));
	    		roomInfo.put("danDiaoSuanJia",String.valueOf(room.getDanDiaoSuanJia()));
	    		roomInfo.put("gangScore", String.valueOf(room.getGangScore()));
	    		roomInfo.put("scoreType", String.valueOf(room.getScoreType()));
	    		roomInfo.put("qiangGangHu", String.valueOf(room.getQiangGangHu()));
	    		if(room.getPlayType().equals(Cnst.PLAY_TYPE_DAIBAO)){
	    			roomInfo.put("hongZhongBao", String.valueOf(room.getHongZhongBao()));
	    			roomInfo.put("guaDaFeng", String.valueOf(room.getGuaDaFeng()));
	    			roomInfo.put("buJiaBuHu", String.valueOf(room.getBuJiaBuHu()));
	    		}
